...
func (x *BidirMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BidirMessage) ProtoMessage() {}

func (x *BidirMessage) ProtoReflect() protoreflect.Message {
	mi := &file_proto_api_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BidirMessage.ProtoReflect.Descriptor instead.
func (*BidirMessage) Descriptor() ([]byte, []int) {
	return file_proto_api_proto_rawDescGZIP(), []int{1}
}

func (x *BidirMessage) GetMsg() string {
	if x != nil {
		return x.Msg
	}
	return ""
...
const file_proto_api_proto_rawDesc = "" +
	...
	"\fBidirMessage\x12\x10\n" +
	"\x03msg\x18\x01 \x01(\tR\x03msg2\xbd\x01\n" +
	"\n" +
	"UniService\x127\n" +
	"\x06Status\x12\x16.google.protobuf.Empty\x1a\x15.proto.StatusResponse\x12?\n" +
	"\fStatusStream\x12\x16.google.protobuf.Empty\x1a\x15.proto.StatusResponse0\x01\x125\n" +
	"\x05Bidir\x12\x13.proto.BidirMessage\x1a\x13.proto.BidirMessage(\x010\x01B.Z,github.com/chrisarmitage/grpc-showcase/protob\x06proto3"
...
var file_proto_api_proto_goTypes = []any{
	...
	(*BidirMessage)(nil),   // 1: proto.BidirMessage
	(*empty.Empty)(nil),    // 2: google.protobuf.Empty
}
var file_proto_api_proto_depIdxs = []int32{
	2, // 0: proto.UniService.Status:input_type -> google.protobuf.Empty
	2, // 1: proto.UniService.StatusStream:input_type -> google.protobuf.Empty
	1, // 2: proto.UniService.Bidir:input_type -> proto.BidirMessage
	0, // 3: proto.UniService.Status:output_type -> proto.StatusResponse
	0, // 4: proto.UniService.StatusStream:output_type -> proto.StatusResponse
	1, // 5: proto.UniService.Bidir:output_type -> proto.BidirMessage
